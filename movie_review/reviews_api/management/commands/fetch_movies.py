...
from django.core.management.base import BaseCommand
from reviews_api.fetch_api import fetch_movies_from_api  # Import the function
from reviews_api.models import Movie
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        if movies:
            ...
            self.stdout.write(self.style.WARNING('No movies fetched or an error occurred'))